...
var _loadCatalogHeroSubject = require("./script/loadCatalogHeroSubject");
var _loadCatalog = require("./script/loadCatalog");
var _btnUp = require("./script/btnUp");
var _pagination = require("./script/pagination");

},{"./scss/catalog.scss":"4V4Vg","./script/switchTheme":"igiAv","./script/loadCatalogHeroSubject":"luR6j","./script/loadCatalog":"3nkPu","./script/btnUp":"kzC4c","./script/pagination":"gOZZS"}],"4V4Vg":[function() {},{}],"luR6j":[function(require,module,exports) {
...
(0, _booksAPI.fetchGenre)("liebe").then((data)=>{
    const obj_book = [];
    data.map((el)=>obj_book.push(new (0, _localList.objBook)(el)));
    genreEl.innerHTML = (0, _renderBooks.renderBooks)(data, "genre", true, false, obj_book);
...
},{"./booksAPI":"lhp3x","./renderBooks":"bhwKj","./localList":"8IMTK"}],"3nkPu":[function(require,module,exports) {
var _booksAPI = require("./booksAPI");
...
(0, _pagination.pagination).on("afterMove", (event)=>{
...
},{"./booksAPI":"lhp3x","./modal":"cmqWk","./pagination":"gOZZS","./renderBooks":"bhwKj"}],"gOZZS":[function(require,module,exports) {
...
},{"tui-pagination":"b80gR","tui-pagination/dist/tui-pagination.css":"82Il4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"82Il4":[function() {},{}]},["crMyb","biTSW"], "biTSW", "parcelRequire78ed")
