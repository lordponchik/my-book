 ...
 *     dh: 'dh'
 * });
 */function(t,e){var n=document.createElement("img"),r="";return i(e,function(t,e){r+="&"+e+"="+t}),r=r.substring(1),n.src=t+"?"+r,n.style.display="none",document.body.appendChild(n),document.body.removeChild(n),n};/***/}]);let f=document.getElementById("pagination"),h=new((t=p)&&t.__esModule?t.default:t)(f,{totalItems:198,itemsPerPage:33,visiblePages:6,page:1,centerAlign:!1,firstItemClassName:"tui-first-child",lastItemClassName:"tui-last-child",template:{page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}});var a=r("kP8Kb");let g=document.querySelector(".sect-catalog__wrapper"),d=document.querySelector(".sect-catalog__input"),_=document.querySelector(".sect-catalog__submit"),v="liebe";function m(t){t.preventDefault(),v=`${d.value.split(" ").join("+")}`,g.innerHTML="",(0,o.fetchCatalog)(v).then(t=>{g.innerHTML=(0,a.renderBooks)(t,"catalog"),h.reset()}).catch(t=>{g.innerHTML=`<p style="text-align:center;color: #fff;">OOPS... <br />
We are very sorry!<br />
We don\u{2019}t have any results matching your search.</p>`})}g.innerHTML="",(0,o.fetchCatalog)(v).then(t=>{g.innerHTML=(0,a.renderBooks)(t,"catalog")}).catch(t=>{g.innerHTML=`<p style="text-align:center;color: #fff;">OOPS... <br />
We are very sorry!</p>`}),_.addEventListener("click",m),d.addEventListener("submit",m),g.addEventListener("click",l.modalShow),h.on("afterMove",t=>{let e=(t.page-1)*33;g.innerHTML="",(0,o.fetchCatalog)(v,e).then(t=>{g.innerHTML=(0,a.renderBooks)(t,"catalog")}).catch(t=>{g.innerHTML=`<p style="text-align:center;color: #fff;">OOPS... <br />
We are very sorry!<br />
We don\u{2019}t have any results matching your search.</p>`}),window.scrollTo({top:d.getBoundingClientRect().y,left:0,behavior:"smooth"})}),r("3OTDN")}();//# sourceMappingURL=catalog.80f21d47.js.map

//# sourceMappingURL=catalog.80f21d47.js.map
