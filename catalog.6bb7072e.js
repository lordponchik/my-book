!function(){function t(t,e,r,n){Object.defineProperty(t,e,{get:r,set:n,enumerable:!0,configurable:!0})}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},o=e.parcelRequire78ed;null==o&&((o=function(t){if(t in r)return r[t].exports;if(t in n){var e=n[t];delete n[t];var o={id:t,exports:{}};return r[t]=o,e.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){n[t]=e},e.parcelRequire78ed=o);var i=o.register;i("ahE03",function(t,e){let r=document.querySelector(".switch-theme"),n={light:r.querySelector(".switch-icon__light"),dark:r.querySelector(".switch-icon__dark")};r.addEventListener("click",()=>{let t=document.documentElement.getAttribute("data-theme"),e="light"===t?"dark":"light";localStorage.setItem("theme",e),document.documentElement.setAttribute("data-theme",e),n[t].classList.toggle("hidden"),n[e].classList.toggle("hidden")})}),i("hAqfH",function(t,e){var r=o("hrCnj"),n=o("7t5ly");let i=document.querySelector(".backdrop"),a=document.querySelectorAll(".book-series__list"),u=document.querySelector(".backdrop__close");function s(t){if(t.target.nodeName===t.currentTarget.nodeName)return;let e="LI"===t.target.nodeName?t.target:t.target.parentNode.parentNode;i.classList.add("show"),f(),(0,r.fetchBook)(e.getAttribute("data-id")).then(t=>{i.firstElementChild.lastElementChild.innerHTML=(0,n.renderModalBook)(t)})}function f(){i.classList.contains("show")?document.body.style.overflow="hidden":document.body.style.removeProperty("overflow")}i.addEventListener("click",function(t){t.target===t.currentTarget&&(t.target.firstElementChild.lastElementChild.innerHTML="",t.target.classList.remove("show"),f())}),u.addEventListener("click",function(){i.firstElementChild.lastElementChild.innerHTML="",i.classList.remove("show"),f()}),a.forEach(t=>{t.addEventListener("click",s)})}),i("hrCnj",function(e,r){t(e.exports,"fetchBooksCategory",function(){return i}),t(e.exports,"fetchBook",function(){return a}),t(e.exports,"fetchGenre",function(){return u}),t(e.exports,"fetchCatalog",function(){return s}),o("dIxxU");var n=o("ke5Oc");async function i(t){let e=`volumes?q=intitle:${t}&printType=books&startIndex=${f(11)}&maxResults=6`,r=await (0,n.default).get(e),o=await r.data,i=await o.items;return i}async function a(t){let e=`volumes/${t}`,r=await (0,n.default).get(e),o=await r.data;return o}async function u(t){let e=`volumes?q=${t}&printType=books&startIndex=${f(500)}&maxResults=10`,r=await (0,n.default).get(e),o=await r.data,i=await o.items;return i}async function s(t){let e=`volumes?q=${t}&printType=books&startIndex=0&maxResults=33`,r=await (0,n.default).get(e),o=await r.data,i=await o.items;return i}function f(t){return Math.floor(Math.random()*t)}n.default.defaults.baseURL="https://www.googleapis.com/books/v1/"}),i("dIxxU",function(e,r){t(e.exports,"default",function(){return o("ke5Oc").default});var n=o("ke5Oc");// This module is intended to unwrap Axios default export as named.
...
let C={};function L(t,e,r){C[t]=class extends r{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
this.name=`${this.name} [${t}]`,// Access the stack to generate the error message including the error code
// from the name.
this.stack// eslint-disable-line no-unused-expressions
,// Reset the name to the actual name.
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function I(t){let e="",r=t.length,n="-"===t[0]?1:0;for(;r>=n+4;r-=3)e=`_${t.slice(r-3,r)}${e}`;return`${t.slice(0,r)}${e}`}function N(t,e,r,n,o,i){if(t>r||t<e){let n;let o="bigint"==typeof e?"n":"";throw n=i>3?0===e||e===BigInt(0)?`>= 0${o} and < 2${o} ** ${(i+1)*8}${o}`:`>= -(2${o} ** ${(i+1)*8-1}${o}) and < 2 ** ${(i+1)*8-1}${o}`:`>= ${e}${o} and <= ${r}${o}`,new C.ERR_OUT_OF_RANGE("value",n,t)}_(o,"offset"),(void 0===n[o]||void 0===n[o+i])&&j(o,n.length-(i+1))}function _(t,e){if("number"!=typeof t)throw new C.ERR_INVALID_ARG_TYPE(e,"number",t)}function j(t,e,r){if(Math.floor(t)!==t)throw _(t,r),new C.ERR_OUT_OF_RANGE(r||"offset","an integer",t);if(e<0)throw new C.ERR_BUFFER_OUT_OF_BOUNDS;throw new C.ERR_OUT_OF_RANGE(r||"offset",`>= ${r?1:0} and <= ${e}`,t)}L("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),L("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),L("ERR_OUT_OF_RANGE",function(t,e,r){let n=`The value of "${t}" is out of range.`,o=r;return Number.isInteger(r)&&Math.abs(r)>4294967296?o=I(String(r)):"bigint"==typeof r&&(o=String(r),(r>BigInt(2)**BigInt(32)||r<-(BigInt(2)**BigInt(32)))&&(o=I(o)),o+="n"),n+=` It must be ${e}. Received ${o}`},RangeError);// HELPER FUNCTIONS
// ================
...
if(t.auth){let e=t.auth.username||"",r=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";w.set("Authorization","Basic "+btoa(e+":"+r))}let B=(0,s.default)(t.baseURL,t.url);function O(){if(!A)return;// Prepare the response
...
o=e=>{A&&(r(!e||e.type?new d.default(null,t,A):e),A.abort(),A=null)},t.cancelToken&&t.cancelToken.subscribe(o),t.signal&&(t.signal.aborted?o():t.signal.addEventListener("abort",o)));let R=(0,h.default)(B);if(R&&-1===(0,p.default).protocols.indexOf(R)){r(new c.default("Unsupported protocol "+R+":",c.default.ERR_BAD_REQUEST,t));return}// Send the request
