var t,e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},i={},r=e.parcelRequire78ed;null==r&&((r=function(t){if(t in n)return n[t].exports;if(t in i){var e=i[t];delete i[t];var r={id:t,exports:{}};return n[t]=r,e.call(r.exports,r,r.exports),r.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){i[t]=e},e.parcelRequire78ed=r),r.register,r("1qHQF");var o=r("04Pik"),s=r("jj8gv");const a=document.querySelector(".hero__wrapper--genre"),u=document.querySelector(".category");let c=u.querySelector(".category__btn.active");(0,o.fetchGenre)("liebe").then(t=>{a.innerHTML=(0,s.renderBooks)(t,"genre",!0)}),u.addEventListener("click",function(t){if("BUTTON"!==t.target.nodeName)return;c.classList.remove("active");let e=t.target;e.classList.add("active"),c=e,a.innerHTML="",(0,o.fetchGenre)(t.target.getAttribute("data-name")).then(t=>{a.innerHTML=(0,s.renderBooks)(t,"genre",!0)})});var o=r("04Pik"),l=r("6mMsB"),p={};window,p=/******/function(t){/******/// The module cache
...
/***/},/* 12 *//***/function(t,e,n){var i=n(13),r=n(7),o=n(0),s=n(1),a=n(20),u=n(9),c={totalItems:10,itemsPerPage:10,visiblePages:10,page:1,centerAlign:!1,firstItemClassName:"tui-first-child",lastItemClassName:"tui-last-child",usageStatistics:!0},l=r(/** @lends Pagination.prototype */{init:function(t,e){/**
       * Option object
       * @type {object}
       * @private
       */this._options=o({},c,e),/**
 ...
 * @author NHN FE Development Lab <dl_javascript@nhn.com>
 */var i=n(0),r=n(14),o=n(4),s=n(16),a=n(2),u=n(5),c=n(3),l=/\s+/g;/**
 * @class
 * @example
 * // node, commonjs
 ...
 * @param {function|object} [handler] - handler function or context
 * @param {object} [context] - context for binding
 */p.prototype.once=function(t,e,n){var i=this;if(s(t)){n=e,c(t,function(t,e){i.once(e,t,n)});return}this.on(t,function r(){e.apply(n,arguments),i.off(t,r,n)},n)},/**
 ...
 * @private
 */p.prototype._matchHandlerAndContext=function(t,e){var n=this;return function(i){var r=t===i.handler,o=e===i.context,s=r&&o;return s&&n._forgetContext(i.context),s}},/**
 * Unbind event by event name
 * @param {string} eventName - custom event name to unbind
 * @param {function} [handler] - handler function
 * @private
 */p.prototype._offByEventName=function(t,e){var n=this,i=u(e),r=n._matchHandler(e);c(t=t.split(l),function(t){var e=n._safeEvent(t);i?n._spliceMatches(e,r):(c(e,function(t){n._forgetContext(t.context)}),n.events[t]=[])})},/**
 ...
 * CustomEvents.off();
 */p.prototype.off=function(t,e){o(t)?this._offByEventName(t,e):arguments.length?u(t)?this._offByHandler(t):s(t)&&this._offByObject(t,e):(// [syntax 8]
...
return e.prototype=t,new e};/***/},/* 20 *//***/function(t,e,n){var i=n(3),r=n(7),o=n(21),s=n(22),a=n(24),u=n(25),c=n(0),l=n(4),p=n(28),f=n(9),h={page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'},g=["first","prev","next","last"],d=["prev","next"],_=r(/** @lends View.prototype */{init:function(t,e,n){/**
       * Root element
       * @type {HTMLElement}
       * @private
     ...
     * @private
     */_setMoreButtons:function(){i(d,function(t){var e=t+"More";this._buttons[e]=f.createElementByTemplate(this._template.moreButton,{type:t})},this)},/* eslint-enable camelcase *//**
 ...
 */function s(t,e,n,i){var s,a;/**
     * Event handler
     * @param {Event} e - event object
     */function u(e){n.call(i||t,e||window.event)}"addEventListener"in t?t.addEventListener(e,u):"attachEvent"in t&&t.attachEvent("on"+e,u),s=o(t,e),a=!1,r(s,function(t){return t.handler!==n||(a=!0,!1)}),a||s.push({handler:n,wrappedHandler:u})}t.exports=/**
 * Bind DOM events.
 * @param {HTMLElement} element - element to bind events
 ...
 */function(t){var e,n=Array.prototype.slice.call(arguments,1),a=t.classList,u=[];if(a){i(n,function(e){t.classList.add(e)});return}(e=o(t))&&(n=[].concat(e.split(/\s+/),n)),i(n,function(t){0>r(t,u)&&u.push(t)}),s(t,u)};/***/},/* 26 *//***/function(t,e,n){/**
 ...
 * @author NHN FE Development Lab <dl_javascript@nhn.com>
 */var i=n(8),r=n(3),o=n(2),s=n(4),a=n(0),u=/{{\s?|\s?}}/g,c=/^[a-zA-Z0-9_@]+\[[a-zA-Z0-9_@"']+\]$/,l=/\[\s?|\s?\]/,p=/^[a-zA-Z_]+\.[a-zA-Z_]+$/,f=/\./,h=/^["']\w+["']$/,g=/"|'/g,d=/^-?\d+\.?\d*$/,_={if:/**
 ...
 * @returns {string}
 * @private
 */function(t,e,n){var i,o,s,a,u=(i=[t],o=[],s=0,a=0,// eslint-disable-next-line complexity
r(e,function(t,n){0===t.indexOf("if")?s+=1:"/if"===t?s-=1:s||0!==t.indexOf("elseif")&&"else"!==t||(i.push("else"===t?["true"]:t.split(" ").slice(1)),o.push(e.slice(a,n)),a=n+1)}),o.push(e.slice(a)),{exps:i,sourcesInsideIf:o}),c=!1,l="";return r(u.exps,function(t,e){return(c=y(t,n))&&(l=x(u.sourcesInsideIf[e],n)),!c}),l},each:/**
 ...
 * @returns {string}
 * @private
 */function(t,e,n){var i=y(t,n),s=o(i)?"@index":"@key",u={},c="";return r(i,function(t,i){u[s]=i,u["@this"]=t,a(n,u),c+=x(e.slice(),n)}),c},with:/**
 ...
 * @returns {string}
 * @private
 */function(t,e,n){var r=i("as",t),o=t[r+1],s=y(t.slice(0,r),n),u={};return u[o]=s,x(e,a(n,u))||""}},v=3==="a".split(/a/).length?function(t,e){return t.split(e)}:function(t,e){var n,i,r=[],o=0;for(e.global||(e=RegExp(e,"g")),n=e.exec(t);null!==n;)i=n.index,r.push(t.slice(o,i)),o=i+n[0].length,n=e.exec(t);return r.push(t.slice(o)),r};/**
 ...
 * @private
 */// eslint-disable-next-line complexity
function m(t,e){var n,i=e[t];return"true"===t?i=!0:"false"===t?i=!1:h.test(t)?i=t.replace(g,""):c.test(t)?i=m((n=t.split(l))[0],e)[m(n[1],e)]:p.test(t)?i=m((n=t.split(f))[0],e)[n[1]]:d.test(t)&&(i=parseFloat(t)),i}/**
 ...
 * @returns {string}
 * @private
 */function y(t,e){var n,i,o=m(t[0],e);return o instanceof Function?(n=t.slice(1),i=[],r(n,function(t){i.push(m(t,e))}),o.apply(null,i)):o}/**
 * Get a result of compiling an expression with the context.
 * @param {Array.<string>} sources - array of sources split by regexp of expression.
 * @param {object} context - context
 * @returns {Array.<string>} - array of sources that bind with its context
 * @private
 */function x(t,e){for(var n,i,r,o=1,a=t[1];s(a);)_[i=(n=a.split(" "))[0]]?(r=/**
 ...
 * @private
 */function(t,e,n){for(var i,r,o,a=_[t],u=1,c=2,l=e[2];u&&s(l);)0===l.indexOf(t)?u+=1:0===l.indexOf("/"+t)&&(u-=1,o=c),c+=2,l=e[c];if(u)throw Error(t+" needs {{/"+t+"}} expression.");return e[0]=a(e[0].split(" ").slice(1),(i=o,(r=e.splice(1,i-0)).pop(),r),n),e}(i,t.splice(o,t.length-o),e),t=t.concat(r)):t[o]=y(n,e),o+=2,a=t[o];return t.join("")}t.exports=/**
 ...
 *     dh: 'dh'
 * });
 */function(t,e){var n=document.createElement("img"),r="";return i(e,function(t,e){r+="&"+e+"="+t}),r=r.substring(1),n.src=t+"?"+r,n.style.display="none",document.body.appendChild(n),document.body.removeChild(n),n};/***/}]);const f=document.getElementById("pagination"),h=new((t=p)&&t.__esModule?t.default:t)(f,{totalItems:198,itemsPerPage:33,visiblePages:6,page:1,centerAlign:!1,firstItemClassName:"tui-first-child",lastItemClassName:"tui-last-child",template:{page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}});var s=r("jj8gv");const g=document.querySelector(".sect-catalog__wrapper"),d=document.querySelector(".sect-catalog__input"),_=document.querySelector(".sect-catalog__submit");let v="liebe";function m(t){t.preventDefault(),v=`${d.value.split(" ").join("+")}`,g.innerHTML="",(0,o.fetchCatalog)(v).then(t=>{g.innerHTML=(0,s.renderBooks)(t,"catalog"),h.reset()}).catch(t=>{g.innerHTML=`<li style="text-align:center;color: #fff;">OOPS... <br />
We are very sorry!<br />
We don\u{2019}t have any results matching your search.</li>`})}g.innerHTML="",(0,o.fetchCatalog)(v).then(t=>{g.innerHTML=(0,s.renderBooks)(t,"catalog")}).catch(t=>{g.innerHTML=`<li style="text-align:center;color: #fff;">OOPS... <br />
We are very sorry!</li>`}),_.addEventListener("click",m),d.addEventListener("submit",m),g.addEventListener("click",l.modalShow),h.on("afterMove",t=>{let e=(t.page-1)*33;g.innerHTML="",(0,o.fetchCatalog)(v,e).then(t=>{g.innerHTML=(0,s.renderBooks)(t,"catalog")}).catch(t=>{g.innerHTML=`<li style="text-align:center;color: #fff;">OOPS... <br />
We are very sorry!<br />
We don\u{2019}t have any results matching your search.</li>`}),window.scrollTo({top:d.getBoundingClientRect().y,left:0,behavior:"smooth"})}),r("8QdEj");//# sourceMappingURL=catalog.bca97e4c.js.map

//# sourceMappingURL=catalog.bca97e4c.js.map
