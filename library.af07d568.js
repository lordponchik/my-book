...
})({"dsceO":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ca17850eaf07d568";
"use strict";
...
},{}],"igiAv":[function(require,module,exports) {
...
},{}],"kzC4c":[function(require,module,exports) {
...
},{}],"lhp3x":[function(require,module,exports) {
...
parcelHelpers.export(exports, "fetchCatalog", ()=>fetchCatalog);
parcelHelpers.export(exports, "fetchRandomBook", ()=>fetchRandomBook);
...
async function fetchBooksCategory(name) {
    const params = `volumes?q=intitle:${name}&printType=books&startIndex=${getRenderStartIndex(11)}&maxResults=6`;
...
async function fetchGenre(subject) {
    const params = `volumes?q=${subject}&printType=books&startIndex=${getRenderStartIndex(500)}&maxResults=10`;
    const response = await (0, _axiosDefault.default).get(params);
    const data = await response.data;
    const items = await data.items;
    return items;
}
async function fetchCatalog(name, num = 0) {
    const maxResults = window.innerWidth < 768 ? 8 : window.innerWidth >= 768 && window.innerWidth < 1280 ? 20 : 33;
...
async function fetchRandomBook(name) {
    const params = `volumes?q=${name}&printType=books&startIndex=${getRenderStartIndex(33)}&maxResults=1`;
    const response = await (0, _axiosDefault.default).get(params);
    const data = await response.data;
    const items = await data.items;
    return items;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bhwKj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderBooks", ()=>renderBooks);
...
function renderBooks(items, name = "book", descr = false, modal = false, obj = []) {
    if (modal === true) return `
  <div class="${name}" data-id="${items.id}">
             <div class="${name}__img"><img src="${thumbnail(items.volumeInfo)}" alt="" width="200"></div>
    ...
    return items.map((item, i)=>{
        return `<div class="${name}" data-id="${item.id}">
           <div class="${name}__container"><div class="${name}__img"><img src="${thumbnail(item.volumeInfo)}" alt="" width="100"></div>
              <div class="${name}__wrapper">
              ...
              ${descr ? ` <p class="${name}__description">${isDescr(item.volumeInfo.description)}</p>` : ""}
...
},{"../image/no-image-placeholder.svg":"CSSrU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"CSSrU":[function(require,module,exports) {
module.exports = require("2570e32871f1c0a").getBundleURL("hlJhh") + "no-image-placeholder.39dde084.svg" + "?" + Date.now();

},{"2570e32871f1c0a":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
var _loadLibrary = require("./loadLibrary");
    ...
    addEvent() {
        ...
        this.btns[this.btns.length === 1 ? 0 : 1].addEventListener("click", (e)=>{
            if (e.currentTarget.textContent === "add book to library") {
                ...
                if (libraryEl !== null) {
                    libraryEl.innerHTML = "";
                    libraryEl.innerHTML = (0, _renderBooks.renderBooks)(temporary\u0421ell.slice(0, (0, _loadLibrary.itemsPerPage)), "library", false, false);
                    (0, _loadLibrary.toPagePagination)();
                }
...
},{"./loadLibrary":"cAlFN","./renderBooks":"bhwKj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cAlFN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "itemsPerPage", ()=>itemsPerPage);
parcelHelpers.export(exports, "toPagePagination", ()=>toPagePagination);
var _renderBooks = require("./renderBooks");
...
There are no books in the library, add the first one.</p>`;
    ...
    pagination = new (0, _tuiPaginationDefault.default)(container, renderOptionsForPagination(localArr));
...
">Oops... </br> We are very sorry! </br>
There are no books in the library, add the first one.</p>`;
        else libraryEl.innerHTML = (0, _renderBooks.renderBooks)(localArr.slice(num, event.page * itemsPerPage), "library", false, false);
        window.scrollTo({
...
},{"./renderBooks":"bhwKj","./modal":"cmqWk","tui-pagination":"b80gR","tui-pagination/dist/tui-pagination.css":"82Il4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cmqWk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function modalShow(e) {
    ...
    (0, _booksAPI.fetchBook)(item.getAttribute("data-id")).then((data)=>{
        const obj_book = [];
        obj_book.push(new (0, _localList.objBook)(data));
...
},{"./booksAPI":"lhp3x","./localList":"8IMTK","./renderBooks":"bhwKj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b80gR":[function(require,module,exports) {
/*!
 * TOAST UI Pagination
 * @version 3.4.1
...
},{}],"82Il4":[function() {},{}]},["dsceO"], null, "parcelRequire78ed")

//# sourceMappingURL=library.af07d568.js.map
